function newRegister() {
    ...
    delBtn.appendChild(delText); // 텍스트 노드가 button자식요소로 연결하기
    newP.appendChild(delBtn); // delBtn p요소의 하위요소로 만들기
    ...
    for(var i = 0; i < removeBtns.length; i++) {
        ...
        removeBtns[i].addEventListener("click", function(){
            // #nameList를 의미 하게 되는 것이다. span태그의 부모가 p이고 p의 부모가 #nameList이기 때문
